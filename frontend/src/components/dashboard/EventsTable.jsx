  ...
  <div className="rounded-3xl border border-white/20 bg-white/70 p-6 shadow-xl backdrop-blur-xl dark:border-white/10 dark:bg-slate-900/70">
    ...
    <div className="mt-4 overflow-hidden rounded-2xl border border-white/30 dark:border-white/10">
      <motion.table className="w-full table-auto border-collapse text-left text-sm">
        <thead className="bg-white/70 text-xs uppercase tracking-wide text-slate-500 dark:bg-slate-900/70 dark:text-slate-400">
          <tr>
        ...
        <tbody>
          ...
          {events.map((event) => (
            <motion.tr
              ...
              className="border-t border-white/20 bg-white/60 text-slate-600 backdrop-blur-xl transition hover:bg-primary/10 dark:border-white/5 dark:bg-slate-900/60 dark:text-slate-200"
            >
